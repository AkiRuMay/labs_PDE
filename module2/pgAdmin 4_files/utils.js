...
define('pgadmin.browser.utils',
  ...
  pgAdmin['csrf_token'] = 'ImFhM2IwMDliYjUyMDJhZTBjYjUyNDk3NGNiNGRkZWE4NzcwMDY4OGEi.Z-Cc4Q.TZClv7CsAEYElhw4UihB6tjp1iE';
  ...
  pgBrowser.utils = {
    layout: "{\"dockbox\":{\"id\":\"+2\",\"size\":200,\"mode\":\"horizontal\",\"children\":[{\"id\":\"+3\",\"size\":326,\"tabs\":[{\"id\":\"id-object-explorer\"}],\"group\":\"object-explorer\",\"activeId\":\"id-object-explorer\"},{\"id\":\"id-main\",\"size\":664,\"tabs\":[{\"id\":\"id-sql\"}],\"group\":\"playground\",\"activeId\":\"id-sql\"}]},\"floatbox\":{\"id\":\"+22\",\"size\":0,\"mode\":\"float\",\"children\":[]},\"windowbox\":{\"id\":\"+23\",\"size\":0,\"mode\":\"window\",\"children\":[]},\"maxbox\":{\"id\":\"+24\",\"size\":1,\"mode\":\"maximize\",\"children\":[]}}",
    theme: '',
  ...
  url: "/help/help/index.html?ver=90000",
  target: "pgadmin_help",
  icon: "fa fa-question",
  ...
  enable: "",
      ...
      gravatar: 'https://www.gravatar.com/avatar/64e1b8d34f425d19e1ee2ea7236d3028?size=100&default=retro&rating=g',
      menus: [
                {
